...
function buildAccessEmailText(record) {
  return [
    ...
    "",
    "Para empezar a descubrir las revelaciones que el Universo guarda para ti, necesitamos conocer tu situación con el cariño y el respeto que merece.",
    "",
...
function normalizeFormPayload(body = {}) {
  return {
    ...
    productName: String(body.productName || body.productTitle || body.tipo || body.tipoConsulta || "").trim(),
