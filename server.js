...
// ✅ Responder preflight (muy importante para evitar problemas en navegador / algunos webhooks)
app.options("*", cors());

app.use(express.json({ limit: "1mb" }));

// Log sencillo (se ve en Railway Logs)
...
const semillaEstelarCards = [
  ...
  // ✅ FIX TYPO (te faltaba un "_" y el prefijo correcto)
  { id: "tribu_alma", name: "Tribu del Alma", image: "Semilla_estelar_Tribu_del_Alma.png", meaning: "" },
...
app.post("/api/create-link", async (req, res) => {
  ...
  // Si tienes ZAPIER_SECRET en Railway, Zapier debe enviar header:
